        ...
        select(co_occurrence).where(
            and_(
                ...
                or_(
                    ...
                    co_occurrence.head_word.like(keyword),
                    co_occurrence.head_word.like(katakana),
                    co_occurrence.target_word.like(keyword),
                    co_occurrence.target_reading.like(katakana),
